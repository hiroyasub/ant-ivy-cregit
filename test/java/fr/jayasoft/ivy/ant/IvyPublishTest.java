...
literal|"ivy.dep.file"
argument_list|,
literal|"test/java/fr/jayasoft/ivy/ant/ivy-publish-multi.xml"
argument_list|)
expr_stmt|;
name|IvyResolve
name|res
...
name|File
argument_list|(
literal|"test/repositories/1/jayasoft/multi/ivys/ivy-1.2.xml"
argument_list|)
operator|.
name|exists
argument_list|()
...
name|File
argument_list|(
literal|"test/repositories/1/jayasoft/multi/jars/multi1-1.2.jar"
argument_list|)
operator|.
name|exists
argument_list|()
...
name|File
argument_list|(
literal|"test/repositories/1/jayasoft/multi/jars/multi2-1.2.jar"
argument_list|)
operator|.
name|exists
argument_list|()
...
literal|"ivy.dep.file"
argument_list|,
literal|"test/java/fr/jayasoft/ivy/ant/ivy-custom.xml"
argument_list|)
expr_stmt|;
name|IvyResolve
name|res
...
name|File
argument_list|(
literal|"test/repositories/1/jayasoft/resolve-custom/ivys/ivy-1.2.xml"
argument_list|)
decl_stmt|;
comment|// should have published the files with "1" resolver
name|assertTrue
...
name|File
argument_list|(
literal|"test/repositories/1/jayasoft/resolve-custom/jars/resolve-custom-1.2.jar"
argument_list|)
operator|.
name|exists
argument_list|()
...
name|File
argument_list|(
literal|"test/java/fr/jayasoft/ivy/ant/ivy-publish.xml"
argument_list|)
argument_list|,
operator|new
name|File
