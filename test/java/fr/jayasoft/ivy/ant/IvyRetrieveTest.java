...
argument_list|,
literal|"build/test/[organisation]/[module]/ivy-[revision].xml"
argument_list|)
expr_stmt|;
comment|// for no ivy retrieve pattern use configured default ivy retrieve pattern
name|_retrieve
operator|.
name|execute
argument_list|()
...
name|ivyPattern
init|=
literal|"build/test/[organisation]/ivy-[module]-[revision].xml"
decl_stmt|;
name|_project
operator|.
name|setProperty
