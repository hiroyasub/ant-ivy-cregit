...
expr_stmt|;
block|}
comment|/**      * Test case for IVY-1315.      *      * @throws Exception if something goes wrong      * @see<a href="https://issues.apache.org/jira/browse/IVY-1315">IVY-1315</a>      */
annotation|@
name|Test
specifier|public
name|void
name|testMergedUpdateWithInclude
parameter_list|()
throws|throws
name|Exception
block|{
...
name|getResource
argument_list|(
literal|"test-update-excludedconfs6.xml"
argument_list|)
decl_stmt|;
name|XmlModuleDescriptorParser
name|parser
...
name|contains
argument_list|(
literal|"dependencies defaultconf=\"conf1->default\""
argument_list|)
argument_list|)
expr_stmt|;
block|}
comment|/**      * Test case for IVY-1419.      *      * @throws Exception if something goes wrong      * @see<a href="https://issues.apache.org/jira/browse/IVY-1419">IVY-1419</a>      */
annotation|@
name|Test
specifier|public
name|void
name|testMergedUpdateWithIncludeAndExcludedConf
parameter_list|()
throws|throws
name|Exception
block|{
