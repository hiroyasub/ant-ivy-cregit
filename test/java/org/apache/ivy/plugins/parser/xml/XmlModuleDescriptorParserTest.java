...
expr_stmt|;
block|}
comment|/**      * Tests that when the<code>location</code> attribute of the<code>extends</code> element of a module descriptor      * file, includes any characters that {@link java.net.URI} considers as encoded characters (for example<code>%2F</code>)      * then the module descriptor and the location of the parent descriptor, are resolved and parsed correctly.      *      * @throws Exception      * @see<a href="https://issues.apache.org/jira/browse/IVY-1562">IVY-1562</a> for more details      */
annotation|@
name|Test
specifier|public
name|void
name|testExtendsEncodedLocation
parameter_list|()
throws|throws
name|Exception
block|{
...
name|getResource
argument_list|(
literal|"foo%2Fbar/hello/test-ivy-extends.xml"
argument_list|)
argument_list|,
literal|true
argument_list|)
