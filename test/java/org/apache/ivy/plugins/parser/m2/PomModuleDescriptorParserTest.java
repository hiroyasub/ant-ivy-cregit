...
name|getResource
argument_list|(
literal|"test-parent-not-found.pom"
argument_list|)
argument_list|,
literal|false
argument_list|)
...
name|getResource
argument_list|(
literal|"test-parent.groupid.pom"
argument_list|)
argument_list|,
literal|false
argument_list|)
...
name|getResource
argument_list|(
literal|"test-project.parent.version.pom"
argument_list|)
argument_list|,
literal|false
argument_list|)
...
comment|// assertEquals(new HashSet<>(Arrays.asList("compile(*)", "runtime(*)", "master(*)")),
comment|// new HashSet<>(Arrays.asList(dds[0].getDependencyConfigurations("optional"))));
name|assertEquals
argument_list|(
name|ModuleRevisionId
operator|.
...
name|assertEquals
argument_list|(
literal|"No exclusion elements were expected to be present for "
operator|+
name|excludeAllTransitiveDepsDescriptor
argument_list|,
literal|0
...
name|excludeAllTransitiveDepsDescriptor
operator|+
literal|" was expected to have transitive=false"
argument_list|,
name|excludeAllTransitiveDepsDescriptor
operator|.
name|isTransitive
...
name|assertEquals
argument_list|(
literal|"https://www.apache.org/licenses/LICENSE-2.0.txt"
argument_list|,
name|licenses
index|[
literal|0
...
specifier|final
name|IvySettings
name|customIvySettings
init|=
name|createIvySettingsForParentLicenseTesting
argument_list|(
literal|"test-parent-with-licenses.pom"
argument_list|,
literal|"org.apache"
argument_list|,
literal|"test-ivy-license-parent"
argument_list|)
decl_stmt|;
specifier|final
name|String
name|pomFile
init|=
literal|"test-project-with-parent-licenses.pom"
decl_stmt|;
specifier|final
name|ModuleDescriptor
name|childModule
...
name|assertNotNull
argument_list|(
literal|"No licenses found in the module "
operator|+
name|childModule
argument_list|,
name|licenses
...
name|assertEquals
argument_list|(
literal|"Unexpected number of licenses found in the module "
operator|+
name|childModule
argument_list|,
literal|1
...
name|assertEquals
argument_list|(
literal|"Unexpected license name"
argument_list|,
literal|"MIT License"
argument_list|,
name|licenses
...
name|assertEquals
argument_list|(
literal|"Unexpected license URL"
argument_list|,
literal|"http://opensource.org/licenses/MIT"
argument_list|,
name|licenses
index|[
literal|0
...
name|pomFile
init|=
literal|"test-project-with-overridden-licenses.pom"
decl_stmt|;
specifier|final
name|ModuleDescriptor
name|childModule
...
name|getResource
argument_list|(
literal|"test-overrideParentVersionPropertyDependencyMgt.pom"
argument_list|)
argument_list|,
literal|false
argument_list|)
...
name|getResource
argument_list|(
literal|"test-override-parent-properties.pom"
argument_list|)
argument_list|,
literal|false
argument_list|)
...
name|getResource
argument_list|(
literal|"test-override-grandparent-properties.pom"
argument_list|)
argument_list|,
literal|false
argument_list|)
...
name|getResource
argument_list|(
literal|"depmgt/profile-parent-child.pom"
argument_list|)
argument_list|,
literal|false
argument_list|)
...
specifier|public
name|void
name|testSystemPropertyAndEnvReferences
parameter_list|()
throws|throws
name|Exception
block|{
...
name|envName
init|=
name|chooseSomeEnvVar
argument_list|()
decl_stmt|;
specifier|final
name|URL
name|originalPomFile
init|=
name|this
operator|.
name|getClass
...
name|getResource
argument_list|(
literal|"test-system-properties.pom"
argument_list|)
decl_stmt|;
name|assertNotNull
argument_list|(
literal|"Pom file to test, is missing"
argument_list|,
name|originalPomFile
argument_list|)
expr_stmt|;
...
name|replaceAll
argument_list|(
literal|"THIS_WILL_BE_REPLACED_IN_TEST_BY_A_ENV_VAR"
argument_list|,
name|envName
argument_list|)
argument_list|)
expr_stmt|;
block|}
comment|// write the new pom contents into a separate file
specifier|final
name|Path
name|updatedPomFile
init|=
...
argument_list|()
argument_list|,
literal|"updated-test-system-properties.pom"
argument_list|)
decl_stmt|;
name|Files
operator|.
...
name|setProperty
argument_list|(
literal|"version.test.system.property.b"
argument_list|,
literal|"1.2.3"
argument_list|)
expr_stmt|;
...
name|assertNotNull
argument_list|(
literal|"Module descriptor created from POM reader was null"
argument_list|,
name|md
argument_list|)
expr_stmt|;
name|assertEquals
argument_list|(
literal|"Unexpected module descriptor created by POM reader"
argument_list|,
name|ModuleRevisionId
operator|.
name|newInstance
...
name|assertNotNull
argument_list|(
literal|"No dependency descriptors found in module descriptor"
argument_list|,
name|dds
argument_list|)
expr_stmt|;
name|assertEquals
argument_list|(
literal|"Unexpected number of dependencies in module descriptor"
argument_list|,
literal|4
argument_list|,
name|dds
...
specifier|final
name|String
name|commonsLoggingDepVersion
init|=
name|envName
operator|==
literal|null
condition|?
literal|"${env.THIS_WILL_BE_REPLACED_IN_TEST_BY_A_ENV_VAR}"
else|:
name|System
operator|.
name|getenv
...
name|assertNotNull
argument_list|(
literal|"Dependency was null in the dependencies"
argument_list|,
name|dd
argument_list|)
expr_stmt|;
...
name|assertTrue
argument_list|(
literal|"Following dependencies were missing from module descriptor "
operator|+
name|expectedDependencies
argument_list|,
name|expectedDependencies
...
specifier|public
name|void
name|testPropertiesDefinedInProfiles
parameter_list|()
throws|throws
name|Exception
block|{
...
name|sysPropToSet
operator|=
literal|"PomModuleDescriptorParserTest.some-other-test-prop"
expr_stmt|;
break|break;
block|}
case|case
...
name|sysPropToSet
operator|=
literal|"PomModuleDescriptorParserTest.some-test-prop"
expr_stmt|;
break|break;
block|}
default|default:
...
name|fail
argument_list|(
literal|"Unexpected packaging type"
argument_list|)
expr_stmt|;
block|}
block|}
comment|// activate the relevant profile, based on a system property
name|System
operator|.
name|setProperty
argument_list|(
...
name|getResource
argument_list|(
literal|"test-properties-in-profile.pom"
argument_list|)
argument_list|,
literal|false
argument_list|)
...
name|assertNotNull
argument_list|(
literal|"Parsed module descriptor was null"
argument_list|,
name|md
argument_list|)
expr_stmt|;
name|assertEquals
argument_list|(
literal|"Unexpected module descriptor"
argument_list|,
name|ModuleRevisionId
operator|.
name|newInstance
...
name|assertNotNull
argument_list|(
literal|"No artifacts found for module"
argument_list|,
name|artifacts
argument_list|)
expr_stmt|;
name|assertEquals
argument_list|(
literal|"Unexpected number of artifacts for module"
argument_list|,
literal|1
argument_list|,
name|artifacts
...
index|]
decl_stmt|;
comment|// make sure that the main artifact which references a conditionally set property (via a Maven profile)
comment|// is indeed using the right value
name|assertEquals
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// some other basic tests
specifier|final
name|DependencyDescriptor
index|[]
name|dds
...
condition|)
block|{
comment|// reset the system prop that we had set
name|System
operator|.
name|clearProperty
argument_list|(
...
name|assertNotNull
argument_list|(
literal|"Missing licenses in parent pom "
operator|+
name|parentPomFileName
argument_list|,
name|parentLicenses
...
name|assertEquals
argument_list|(
literal|"Unexpected number of licenses in parent pom "
operator|+
name|parentPomFileName
argument_list|,
literal|1
