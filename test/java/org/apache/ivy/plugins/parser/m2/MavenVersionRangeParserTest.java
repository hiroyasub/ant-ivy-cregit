...
expr_stmt|;
block|}
comment|/**      * Tests the {@link MavenVersionRangeParser#rangeAccepts(String, String)} works correctly when a range of the form      * {@code (,1.0],[1.2,)} is used to compare against some value.      *      * @throws Exception      */
annotation|@
name|Test
specifier|public
name|void
...
literal|"(,1.0],[1.2,)"
decl_stmt|;
comment|// x<= 1.0 or x>= 1.2
name|assertTrue
argument_list|(
literal|"Range with multiple sets was expected to match"
argument_list|,
name|MavenVersionRangeParser
operator|.
name|rangeAccepts
...
name|assertFalse
argument_list|(
literal|"Range with multiple sets wasn't expected to match"
argument_list|,
name|MavenVersionRangeParser
operator|.
name|rangeAccepts
...
expr_stmt|;
block|}
comment|/**      * Tests the {@link MavenVersionRangeParser#rangeAccepts(String, String)} works correctly when a range of the form      * {@code (,1.1),(1.1,)} is used to compare against some value.      *      * @throws Exception      */
annotation|@
name|Test
specifier|public
name|void
