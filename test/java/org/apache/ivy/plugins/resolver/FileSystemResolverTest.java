...
argument_list|()
operator|+
literal|"/test/repositories/multi-ivypattern/ivy1/ivy-[revision].xml"
argument_list|)
expr_stmt|;
name|resolver
operator|.
...
argument_list|()
operator|+
literal|"/test/repositories/multi-ivypattern/ivy2/ivy-[revision].xml"
argument_list|)
expr_stmt|;
name|ModuleRevisionId
name|mrid
...
name|setName
argument_list|(
literal|"sha256-checksum-resolver"
argument_list|)
expr_stmt|;
name|resolver
operator|.
...
argument_list|()
operator|+
literal|"/test/repositories/checksums/[module]/[revision]/[artifact]-[revision].[ext]"
argument_list|)
expr_stmt|;
name|resolver
operator|.
...
name|assertNotNull
argument_list|(
literal|"Resolved module revision was null for "
operator|+
name|mrid
argument_list|,
name|rmr
...
name|ArtifactDownloadReport
index|[]
name|successfulDownloadReports
init|=
name|dr
operator|.
name|getArtifactsReports
...
name|assertNotNull
argument_list|(
literal|"No artifacts were downloaded successfully"
argument_list|,
name|successfulDownloadReports
argument_list|)
expr_stmt|;
name|assertEquals
argument_list|(
literal|"Unexpected number of successfully downloaded artifacts"
argument_list|,
literal|1
argument_list|,
name|successfulDownloadReports
...
name|assertEquals
argument_list|(
literal|"Unexpected organization of downloaded artifact"
argument_list|,
literal|"test"
argument_list|,
name|downloadedArtifact
...
name|assertEquals
argument_list|(
literal|"Unexpected module of downloaded artifact"
argument_list|,
literal|"allright"
argument_list|,
name|downloadedArtifact
...
name|assertEquals
argument_list|(
literal|"Unexpected revision of downloaded artifact"
argument_list|,
literal|"2.0"
argument_list|,
name|downloadedArtifact
...
argument_list|()
operator|+
literal|"/test/repositories/1/[organisation]/[module]/[revision]/[artifact].[ext]"
argument_list|)
expr_stmt|;
name|resolver
operator|.
...
argument_list|()
operator|+
literal|"/test/repositories/1/[organisation]/[module]/[revision]/[artifact]-[revision].[ext]"
argument_list|)
expr_stmt|;
name|File
name|ivyFile
...
name|File
argument_list|(
literal|"test/repositories/1/myorg/mymodule/myrevision/myartifact-myrevision.myext"
argument_list|)
decl_stmt|;
name|touch
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// files should not be available until the transaction is committed
name|resolver
operator|.
name|publish
argument_list|(
...
argument_list|()
operator|+
literal|"/test/repositories/1/[organisation]/[module]/[branch]/[revision]/[artifact].[ext]"
argument_list|)
expr_stmt|;
name|resolver
operator|.
...
argument_list|()
operator|+
literal|"/test/repositories/1/[organisation]/[module]/[branch]/[revision]/[artifact]-[revision].[ext]"
argument_list|)
expr_stmt|;
name|ModuleRevisionId
name|mrid
...
name|File
argument_list|(
literal|"test/repositories/1/myorg/mymodule/mybranch/myrevision/ivy.xml"
argument_list|)
operator|.
name|exists
argument_list|()
...
name|File
argument_list|(
literal|"test/repositories/1/myorg/mymodule/mybranch/myrevision/myartifact-myrevision.myext"
argument_list|)
operator|.
name|exists
argument_list|()
...
argument_list|()
operator|+
literal|"/test/repositories/1/[organisation]/[module]/[revision]/[type]/[artifact].[ext]"
argument_list|)
expr_stmt|;
name|resolver
operator|.
...
argument_list|()
operator|+
literal|"/test/repositories/1/[organisation]/[module]/[revision]/[type]/[artifact]-[revision].[ext]"
argument_list|)
expr_stmt|;
name|ModuleRevisionId
name|mrid
...
name|File
argument_list|(
literal|"test/repositories/1/myorg/mymodule/myrevision/ivy/ivy.xml"
argument_list|)
operator|.
name|exists
argument_list|()
...
name|File
argument_list|(
literal|"test/repositories/1/myorg/mymodule/myrevision/mytype/myartifact-myrevision.myext"
argument_list|)
operator|.
name|exists
argument_list|()
...
name|File
argument_list|(
literal|"test/repositories/m2/org/apache/mymodule/myrevision/ivy-myrevision.xml"
argument_list|)
operator|.
name|exists
argument_list|()
...
name|File
argument_list|(
literal|"test/repositories/m2/org/apache/mymodule/myrevision/myartifact-myrevision.myext"
argument_list|)
operator|.
name|exists
argument_list|()
...
name|File
argument_list|(
literal|"test/repositories/m2/org/apache/mymodule"
argument_list|)
argument_list|)
expr_stmt|;
block|}
...
name|addArtifactPattern
argument_list|(
comment|// this pattern is not supported for transaction publish
name|settings
operator|.
name|getBaseDir
argument_list|()
operator|+
literal|"/test/repositories/1/[organisation]/[module]/[artifact]-[revision].[ext]"
argument_list|)
expr_stmt|;
name|ModuleRevisionId
name|mrid
...
name|fail
argument_list|(
literal|"publishing with transaction=true and an unsupported pattern should raise an exception"
argument_list|)
expr_stmt|;
block|}
catch|catch
...
argument_list|)
expr_stmt|;
comment|// the two patterns are inconsistent and thus not supported for transactions
name|resolver
operator|.
name|addIvyPattern
argument_list|(
...
name|fail
argument_list|(
literal|"publishing with transaction=true and an unsupported combination of patterns should raise an exception"
argument_list|)
expr_stmt|;
block|}
catch|catch
...
try|try
block|{
comment|// overwrite transaction not supported
name|resolver
operator|.
name|beginPublishTransaction
argument_list|(
...
name|fail
argument_list|(
literal|"publishing with transaction=true and overwrite mode should raise an exception"
argument_list|)
expr_stmt|;
block|}
catch|catch
...
argument_list|)
expr_stmt|;
comment|// with transactions disabled the file should be available as soon as they are published
name|resolver
operator|.
name|publish
argument_list|(
