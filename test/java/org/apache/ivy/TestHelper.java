...
block|}
block|}
comment|/**      * Find a TCP/IP port which may continue to be available.      *<br />      * The returned port is available since a socket has successfully bind to it, but this availability is not ensured      * after this method since the associated socket is released and some other process can now use it.      */
specifier|public
specifier|static
name|int
...
argument_list|(
literal|"Not TCP/IP port available"
argument_list|)
throw|;
block|}
block|}
