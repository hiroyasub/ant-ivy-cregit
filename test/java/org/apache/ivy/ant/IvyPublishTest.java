...
expr_stmt|;
block|}
comment|/**      * Expected failure: publish with haltonmissing and a missing artifact      */
annotation|@
name|Test
specifier|public
name|void
...
name|expectMessage
argument_list|(
literal|"missing artifact apache#resolve-simple;1.2!resolve-simple.jar"
argument_list|)
expr_stmt|;
name|project
operator|.
...
block|{
comment|// should have delivered the ivy file
name|assertTrue
argument_list|(
operator|new
name|File
...
block|}
block|}
comment|/**      * Expected failure: publish with haltonmissing and a missing artifact      *      * @throws IOException when copy fails      */
annotation|@
name|Test
specifier|public
name|void
...
name|expectMessage
argument_list|(
literal|"missing artifact apache#multi;1.2!multi2.jar"
argument_list|)
expr_stmt|;
name|project
operator|.
