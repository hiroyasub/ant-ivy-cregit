...
expr_stmt|;
block|}
comment|/**      * @see "https://bz.apache.org/bugzilla/show_bug.cgi?id=62502"      */
annotation|@
name|Test
specifier|public
name|void
name|isLeadingPathCannotBeFooledByTooManyDoubleDots
parameter_list|()
block|{
name|Assert
operator|.
...
specifier|public
name|void
name|isLeadingPathCanonicalVersionCannotBeFooledByTooManyDoubleDots
parameter_list|()
throws|throws
name|IOException
block|{
...
specifier|public
name|void
name|isLeadingPathCanonicalVersionWorksAsExpectedOnUnix
parameter_list|()
throws|throws
name|IOException
block|{
...
name|assumeFalse
argument_list|(
literal|"Test doesn't run on DOS"
argument_list|,
name|PATH_SEP
operator|.
name|equals
...
specifier|public
name|void
name|isLeadingPathAndTrailingSlashesOnUnix
parameter_list|()
throws|throws
name|IOException
block|{
...
specifier|public
name|void
name|isLeadingPathCanonicalVersionWorksAsExpectedOnDos
parameter_list|()
throws|throws
name|IOException
block|{
...
specifier|public
name|void
name|isLeadingPathAndTrailingSlashesOnDos
parameter_list|()
throws|throws
name|IOException
block|{
