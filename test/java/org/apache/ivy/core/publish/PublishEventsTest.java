...
expr_stmt|;
block|}
comment|/**      * Assert that two Artifact instances refer to the same artifact and contain the same metadata.      *      * @param message      *            String      * @param expected      *            Artifact      * @param actual      *            Artifact      */
specifier|public
specifier|static
name|void
name|assertSameArtifact
