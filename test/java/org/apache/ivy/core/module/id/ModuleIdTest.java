...
name|fail
argument_list|(
literal|"A IllegalArgumentException should have been thrown for the argument 'name'."
argument_list|)
expr_stmt|;
block|}
catch|catch
...
name|fail
argument_list|(
literal|"A NullPointerException was expected."
argument_list|)
expr_stmt|;
block|}
catch|catch
...
name|fail
argument_list|(
literal|"A ClassCastException was expected."
argument_list|)
expr_stmt|;
block|}
catch|catch
