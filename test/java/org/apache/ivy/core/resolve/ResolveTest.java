...
expr_stmt|;
block|}
comment|/*     public void testMultipleEviction() throws Exception {                  ResolveReport report = ivy.resolve(             new File("test/repositories/1/IVY-644/M1/ivys/ivy-1.0.xml").toURL(),             getResolveOptions(new String[] {"*"}));         assertFalse(report.hasError());     }     */
specifier|public
name|void
...
specifier|public
name|void
name|testResolveMaven2Relocation
parameter_list|()
throws|throws
name|Exception
block|{
