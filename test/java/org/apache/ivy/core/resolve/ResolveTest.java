...
specifier|public
name|void
name|testResolveWithSpecifiedCache
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|()
decl_stmt|;
comment|// verify that the module in the default cache doesn't exist
name|assertEquals
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// verify the artifact does exist in the non-default cache.
name|CacheManager
...
block|{
comment|// delete the non-default cache
name|Delete
name|del
init|=
operator|new
