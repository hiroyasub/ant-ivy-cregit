...
specifier|public
name|void
name|testMavenTimedSnapshotVersionMatcher
parameter_list|()
throws|throws
name|Exception
block|{
...
name|getResource
argument_list|(
literal|"ivysettings-maven-tsnap-vmatcher.xml"
argument_list|)
argument_list|)
expr_stmt|;
specifier|final
name|VersionMatcher
name|mavenTSnapVersionMatcher
init|=
name|settings
operator|.
name|getVersionMatcher
...
name|assertNotNull
argument_list|(
literal|"Maven timestamped snapshot version matcher is missing"
argument_list|,
name|mavenTSnapVersionMatcher
argument_list|)
expr_stmt|;
name|assertTrue
argument_list|(
literal|"Unexpected type for Maven timestamped snapshot version matcher"
argument_list|,
name|mavenTSnapVersionMatcher
operator|instanceof
name|MavenTimedSnapshotVersionMatcher
