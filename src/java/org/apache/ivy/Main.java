...
name|withDescription
argument_list|(
literal|"extra classpath, used only in combination with option main"
argument_list|)
operator|.
name|create
argument_list|(
...
name|options
argument_list|,
literal|"dependency should be expressed with exactly 3 arguments: "
operator|+
literal|"organisation module revision"
argument_list|)
expr_stmt|;
