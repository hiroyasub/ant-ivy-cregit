...
begin_comment
comment|/**  * Creates an ant fileset consisting in all artifacts found during a resolve.  * Note that this task is not compatible with the useOrigin mode.  *   * @author Xavier Hanin   */
end_comment
