...
name|format
argument_list|(
literal|"using inline mode to resolve %s %s %s (%s)"
argument_list|,
name|getOrganisation
argument_list|()
argument_list|,
...
name|format
argument_list|(
literal|"inline resolve already done for %s %s %s (%s)"
argument_list|,
name|getOrganisation
argument_list|()
argument_list|,
...
argument_list|)
decl_stmt|;
comment|// if the report does not exist any longer, we have to recreate it...
if|if
condition|(
name|report
operator|.
