...
parameter_list|()
block|{
comment|// since a module can fit a requirement with a different id, no not check anything
return|return
literal|false
return|;
block|}
...
argument_list|)
decl_stmt|;
comment|// only check revision if we're searching for a bundle (package and bundle have different version
if|if
condition|(
name|osgiAtt
operator|==
