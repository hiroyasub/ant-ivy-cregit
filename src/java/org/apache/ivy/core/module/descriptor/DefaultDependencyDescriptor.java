...
comment|// initialized on demand only for memory consumption reasons
specifier|private
name|Map
argument_list|<
name|String
...
continue|continue;
block|}
comment|/*                                  * we do not handle special confs like *!sg or [cond]* in right hand                                  * confs yet: it would require supporting parenthesis grouping in                                  * configurations intersection interpretation                                  *                                  * for (String depConf : depConfs) {                                  *    if (depConf.startsWith("*")) {                                  *       if (intersectedDepConf.contains("(" + depConf + ")")) {                                  *          intersectedDepConfs.add(intersectedDepConf);                                  *       } else {                                  *          intersectedDepConfs.add("(" + intersectedDepConf + ")+(" + depConf + ")");                                  *       }                                  *    } else if (intersectedDepConf.startsWith("*")) {                                  *       if (depConf.contains("(" + intersectedDepConf + ")")) {                                  *          intersectedDepConfs.add(depConf);                                  *       } else {                                  *          intersectedDepConfs.add(depConf + "+" + intersectedDepConf);                                  *       }                                  *    }                                  * }                                  */
block|}
block|}
block|}
block|}
