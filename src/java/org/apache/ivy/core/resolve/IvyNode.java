...
argument_list|()
decl_stmt|;
comment|// get the resolver configured on the engine and if none is configured then
comment|// get the one configured in ivy settings
name|DependencyResolver
name|resolver
init|=
name|engine
...
block|}
block|}
comment|// now exclude artifacts that aren't accepted by any caller
name|Iterator
argument_list|<
name|Artifact
argument_list|>
