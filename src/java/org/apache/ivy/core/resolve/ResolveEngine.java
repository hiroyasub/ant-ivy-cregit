...
block|}
block|}
comment|/**      * Returns the module revision id constraint requested by the given dependency descriptor,      * according to the given resolve options.      *       * @param dd      *            the dependency descriptor for which the requested module revision id should be      *            returned      * @param options      *            the resolve options to use      * @return the {@link ModuleRevisionId} corresponding to the requested dependency constraint      */
specifier|public
name|ModuleRevisionId
name|getRequestedDependencyRevisionId
parameter_list|(
