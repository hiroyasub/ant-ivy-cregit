...
argument_list|)
expr_stmt|;
comment|//We can not use the setSettingsVariables(URL) because that would put different
comment|//values for the properties.  I'm not sure what would be the regression...
block|}
operator|new
name|XmlSettingsParser
argument_list|(
