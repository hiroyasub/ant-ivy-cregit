...
return|;
block|}
comment|/**      * Sets the connection timeout of this timeout constraint      * @param connectionTimeout The connection timeout in milli seconds.      */
specifier|public
name|void
...
expr_stmt|;
block|}
comment|/**      * Sets the read timeout of this timeout constraint      * @param readTimeout The read timeout in milli seconds.      */
specifier|public
name|void
name|setReadTimeout
parameter_list|(
