...
return|;
block|}
comment|/**      * Converts the given module id to a Map containing entries for the organisation and module      * name.      *       * @param moduleId      *            the module id to convert      * @return a Map with exactly two entries, one for the organisation, one for the module name.      */
specifier|private
name|Map
name|getAttributes
parameter_list|(
