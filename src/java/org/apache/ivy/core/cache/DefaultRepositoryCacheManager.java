...
name|checkAbsolute
argument_list|(
name|parseArtifactOriginFilePath
argument_list|(
name|origin
argument_list|)
argument_list|,
...
name|RuntimeException
argument_list|(
literal|"Failed to determine artifact origin for "
operator|+
name|mrid
argument_list|)
throw|;
...
condition|)
block|{
comment|// no need to parse it into a URI, if it's not a "file" scheme URI
return|return
name|location
return|;
block|}
...
condition|)
block|{
comment|// no scheme in URI, just return the original location
return|return
name|location
return|;
block|}
...
return|;
block|}
comment|// not a "file" scheme URI, just return back the original location
return|return
name|location
return|;
block|}
