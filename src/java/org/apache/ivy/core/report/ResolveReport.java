...
name|md
decl_stmt|;
comment|/** String conf -> ConfigurationResolveReport report */
specifier|private
name|Map
name|confReports
init|=
...
condition|)
block|{
comment|// add dependency we want to keep from the original module descriptor
name|DependencyDescriptor
index|[]
name|deps
init|=
...
condition|)
block|{
comment|// no artifact: it was probably useful transitively, hence it is useless here
break|break;
block|}
name|DefaultDependencyDescriptor
name|dep
