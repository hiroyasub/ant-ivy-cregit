...
argument_list|()
decl_stmt|;
comment|// TODO: Use the newer way of settings the connection timeout via HttpConnectionManagerParams
comment|// once we stop support for HttpClient 2.x version
name|client
operator|.
...
argument_list|()
decl_stmt|;
comment|// TODO: Use the newer way of settings the connection and read timeout via HttpConnectionManagerParams
comment|// once we stop support for HttpClient 2.x version
name|client
operator|.
name|setConnectionTimeout
