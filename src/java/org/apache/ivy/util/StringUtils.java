...
return|;
block|}
comment|/**      * Returns the error message associated with the given exception. Th error message returned will      * try to be as precise as possible, handling cases where e.getMessage() is not meaningful, like      * {@link NullPointerException} for instance.      *       * @param e      *            the exception to get the error message from      * @return the error message of the given exception      */
specifier|public
specifier|static
name|String
