...
return|;
block|}
comment|/**      * Joins the given string array in one string, each separated by the given separator.      *      * Example:      *      *<pre>      * joinArray(new String[] {"one", "two", "three"}, ", ") -&gt; "one, two, three"      *</pre>      *      * @param objs      *            The array of strings.      * @param sep      *            The separator to use.      * @return The concatenated string.      */
specifier|public
specifier|static
name|String
name|joinArray
...
return|;
block|}
comment|/**      * Splits the given string into a string array using comma as a separator.      * Every array member gets {@link String#trim() trimmed}.      *      * @param list the string      * @return String[]      */
specifier|public
specifier|static
name|String
index|[]
...
return|;
block|}
comment|/**      * Checks that a string is not null or consists of whitespace by {@link String#trim() trimming}      * and checking the {@link String#isEmpty() length} of the result.      *      * @param s the string to check      * @return boolean      */
specifier|public
specifier|static
name|boolean
name|isNullOrEmpty
...
return|;
block|}
comment|/**      * Asserts that the passed<code>value</code> is not null and not an empty {@link String}.      * The implementation of this method {@link String#trim() trims} the (non-null)      *<code>value</code> to check whether the value is an empty string. If the<code>value</code>      * is either null or empty, then this method throws an {@link IllegalArgumentException}      * with the passed<code>errorMessage</code> as the message in the exception.      *      * @param value        The value to check for      * @param errorMessage The error message      */
specifier|public
specifier|static
name|void
