...
argument_list|()
decl_stmt|;
comment|// TODO: this should be done with a lock on the metadata artifact (moved to the cache manager)
try|try
block|{
name|File
name|ivyFile
...
block|}
block|}
comment|// TODO: this should be done while the lock on the original artifact is acquired (in cache manager #download)
