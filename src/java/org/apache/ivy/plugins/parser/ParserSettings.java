...
parameter_list|)
function_decl|;
comment|/**      * @param name The name of the {@link TimeoutConstraint}      * @return Returns a {@link TimeoutConstraint} which is identified by the passed<code>name</code>. Returns null      * if no such {@link TimeoutConstraint} exists      */
name|TimeoutConstraint
