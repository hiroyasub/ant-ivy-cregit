...
condition|)
block|{
comment|// the filesystem contains a parent module with different organisation
comment|// or module name; ignore that parent module
name|Message
operator|.
name|info
argument_list|(
literal|"Found a parent module with unexpected ModuleRevisionId at source location "
operator|+
name|location
operator|+
literal|"! Expected: "
...
name|foundMid
operator|+
literal|". This parent module will be ignored."
argument_list|)
expr_stmt|;
name|parent
operator|=
...
name|IOException
argument_list|(
literal|"Resolved location "
operator|+
name|url
operator|+
literal|", of parent module descriptor, is not a file"
argument_list|)
throw|;
block|}
name|file
