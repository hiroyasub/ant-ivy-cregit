...
literal|null
decl_stmt|;
comment|// defaultConf of imported configurations, if any
specifier|private
name|String
name|defaultConf
init|=
...
condition|)
block|{
name|startElementWithConfAttributes
argument_list|(
name|qName
argument_list|,
name|attributes
...
block|}
block|}
comment|// add default conf if needed
if|if
condition|(
name|defaultConf
operator|!=
...
comment|// Check if the following code is correct in that case
name|String
name|fileName
init|=
name|attributes
