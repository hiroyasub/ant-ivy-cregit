...
comment|// declare the extra attribute namespace if not declared yet
if|if
condition|(
operator|!
name|md
...
name|res
operator|+
literal|": no module revision id found. "
operator|+
literal|"Check that this pom has a groupId, artifactId and version."
argument_list|,
literal|0
argument_list|)
throw|;
