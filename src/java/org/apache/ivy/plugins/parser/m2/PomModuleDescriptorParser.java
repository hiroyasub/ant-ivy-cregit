...
block|{
return|return;
comment|//                    TODO: maybe do something like this:
comment|//                    ResolveEngine engine = IvyContext.getContext().getIvy().getResolveEngine();
comment|//                    ResolveOptions options = new ResolveOptions();
comment|//                    options.setCache(IvyContext.getContext().getCacheManager());
comment|//                    options.setDownload(false);
comment|//                    data = new ResolveData(engine, options);
block|}
name|ResolvedResource
name|rr
init|=
