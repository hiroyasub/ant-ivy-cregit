...
expr_stmt|;
block|}
comment|//TODO add also the properties to the moduleDescriptor so that it can be inherited
comment|//mdBuilder.addProperty(pomProperties);
for|for
control|(
name|Iterator
name|it
