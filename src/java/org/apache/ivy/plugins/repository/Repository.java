...
parameter_list|)
function_decl|;
comment|/**      * Return the name of the repository      *      * @return String name      */
name|String
name|getName
parameter_list|()
function_decl|;
