...
return|;
block|}
comment|/**      * Reads out the output of a ssh session exec      *      * @param channel      *            Channel to read from      * @param strStdout      *            StringBuilder that receives Session Stdout output      * @param strStderr      *            StringBuilder that receives Session Stderr output      * @throws IOException      *             in case of trouble with the network      */
specifier|private
name|void
