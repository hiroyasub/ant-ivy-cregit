...
argument_list|()
decl_stmt|;
comment|// Map (ModuleIdConf -> Set(Node))
specifier|private
name|Map
name|_evicted
init|=
...
argument_list|()
decl_stmt|;
comment|// Map (root module conf -> EvictionData)
...
specifier|private
name|Map
name|_dependencyArtifactsExcludes
init|=
operator|new
name|HashMap
argument_list|()
...
argument_list|)
expr_stmt|;
comment|// update dependencyArtifactsExcludes
name|updateMapOfSetForKey
argument_list|(
name|node
operator|.
...
return|;
block|}
comment|/**      * Returns all the artifacts of this dependency required in the      * root module configurations in which the node is not evicted      * @return      */
specifier|public
name|Artifact
index|[]
...
block|}
block|}
comment|// now excludes artifacts in the exclude list
name|Set
name|excludes
init|=
operator|(
