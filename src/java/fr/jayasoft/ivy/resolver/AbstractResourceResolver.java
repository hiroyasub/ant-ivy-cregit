...
return|;
block|}
comment|/**      * No need to implement that in post 1.4 dependency resolvers.      * @deprecated       * @return      */
specifier|protected
name|ResolvedResource
name|findResourceUsingPattern
parameter_list|(
...
parameter_list|)
block|{
comment|// implemented for backward compatibility reason only.
comment|// in post 1.4 dependency resolvers this has no utility except to let old code use this old method
comment|// WARNING: if none of the two methods is overriden, this will result in a StackOverflow error !
return|return
name|findResourceUsingPattern
argument_list|(
name|mrid
...
block|{
comment|// implemented for backward compatibility reason only.
comment|// MUST be overriden in post 1.4 dependency resolvers
return|return
name|findResourceUsingPattern
argument_list|(
name|mrid
