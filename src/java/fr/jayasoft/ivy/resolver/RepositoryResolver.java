...
name|debug
argument_list|(
literal|"only one resource found: no need to use latest strategy"
argument_list|)
expr_stmt|;
name|found
operator|=
...
return|;
block|}
comment|/**      * Returns all resolved res matching the given pattern and matching given mrid,       * or null if no lister is able to handle the given pattern      */
specifier|protected
name|ResolvedResource
index|[]
name|findAll
