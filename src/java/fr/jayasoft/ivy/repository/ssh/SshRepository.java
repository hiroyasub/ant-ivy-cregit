...
return|;
block|}
comment|/**      * fetch the needed file information for a given file (size, last modification time)      * and report it back in a SshResource      * @param uri ssh uri for the file to get info for      * @return SshResource filled with the needed informations 	 * @see fr.jayasoft.ivy.repository.Repository#getResource(java.lang.String) 	 */
specifier|public
name|SshResource
...
block|}
block|}
comment|/* (non-Javadoc) 	 * @see fr.jayasoft.ivy.repository.Repository#list(java.lang.String) 	 */
specifier|public
name|List
name|list
parameter_list|(
...
return|;
block|}
comment|/* (non-Javadoc) 	 * @see fr.jayasoft.ivy.repository.Repository#put(java.io.File, java.lang.String, boolean) 	 */
specifier|public
name|void
name|put
parameter_list|(
...
return|;
block|}
comment|/* (non-Javadoc)      * @see fr.jayasoft.ivy.repository.Repository#get(java.lang.String, java.io.File)      */
specifier|public
name|void
name|get
parameter_list|(
