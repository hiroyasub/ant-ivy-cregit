...
block|}
block|}
comment|/**      * Copy xml header from src url ivy file to given printwriter      * In fact, copies everything before<ivy-module to out, except      * if<ivy-module is not found, in which case nothing is copied.      *       * @param in      * @param out      * @throws IOException      */
specifier|private
specifier|static
name|void
name|copyHeader
